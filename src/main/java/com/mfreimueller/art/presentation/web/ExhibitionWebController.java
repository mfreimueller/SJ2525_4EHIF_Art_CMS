...
@Controller
@RequestMapping("/web/exhibitions")
public class ExhibitionWebController {
    ...
    public String list(Model model) {
        var all = service.getExhibitions(Pageable.unpaged()).getContent();
        model.addAttribute("exhibitions", all);
    ...
    public String create(
        ...
        return "redirect:/web/exhibitions/" + exhibition.getId().id();
    }
    ...
    public String edit(
        ...
        return "redirect:/web/exhibitions/" + key;
    }

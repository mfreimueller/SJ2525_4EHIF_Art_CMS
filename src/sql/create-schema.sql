...
create table audio_content (id bigint not null, primary key (id));
create table audio_content_transcriptions (link_type char(1), audio_content_id bigint not null, code varchar(255) not null, file_path varchar(255), name varchar(255) not null, primary key (audio_content_id, code, name));
create table collection (created_at timestamp(6) with time zone, created_by_id bigint, id bigint not null, updated_at timestamp(6) with time zone, updated_by_id bigint, version bigint, primary key (id));
create table collection_point_of_interest (collection_id bigint not null, points_of_interest_id bigint not null, primary key (collection_id, points_of_interest_id));
create table collection_sub_collections (collection_id bigint not null, sub_collections_id bigint not null unique, primary key (collection_id, sub_collections_id));
create table collection_titles (collection_id bigint not null, code varchar(255) not null, name varchar(255) not null, title varchar(255), primary key (collection_id, code, name));
create table content_localized_descriptions (content_id bigint not null, code varchar(255) not null, description varchar(255), name varchar(255) not null, primary key (content_id, code, name));
create table content_base (created_at timestamp(6) with time zone, created_by_id bigint, id bigint not null, updated_at timestamp(6) with time zone, updated_by_id bigint, version bigint, primary key (id));
create table creator (role char(1), id bigint not null, version bigint, username varchar(64) not null, primary key (id));
create table exhibition_languages (exhibition_group_id bigint not null, code varchar(255), name varchar(255));
create table exhibiton (group_id bigint not null, primary key (group_id));
create table image_content (link_type char(1), content_id bigint not null, file_path varchar(255), primary key (content_id));
create table point_of_interest (created_at timestamp(6) with time zone, created_by_id bigint, id bigint not null, updated_at timestamp(6) with time zone, updated_by_id bigint, version bigint, primary key (id));
create table point_of_interest_descriptions (point_of_interest_id bigint not null, code varchar(255) not null, description varchar(255), name varchar(255) not null, primary key (point_of_interest_id, code, name));
create table point_of_interest_titles (point_of_interest_id bigint not null, code varchar(255) not null, name varchar(255) not null, title varchar(255), primary key (point_of_interest_id, code, name));
create table slideshow_content (duration integer, mode char(1), content_id bigint not null, primary key (content_id));
create table slideshow_content_slides (slides_id bigint not null unique, slideshow_content_content_id bigint not null);
create table text_content (content_id bigint not null, primary key (content_id));
create table text_content_long_texts (text_content_content_id bigint not null, code varchar(255) not null, long_text varchar(255), name varchar(255) not null, primary key (text_content_content_id, code, name));
create table text_content_short_texts (text_content_content_id bigint not null, code varchar(255) not null, name varchar(255) not null, short_text varchar(255), primary key (text_content_content_id, code, name));
create table video_content (id bigint not null, primary key (id));
create table video_content_sources (link_type char(1), video_content_id bigint not null, code varchar(255) not null, file_path varchar(255), name varchar(255) not null, primary key (video_content_id, code, name));
create table visit_history (duration integer, id bigint not null, version bigint, visited_on timestamp(6) with time zone, primary key (id));
create table visit_history_point_of_interest (points_of_interest_id bigint not null, visit_history_id bigint not null);
create table visitor (id bigint not null, version bigint, username varchar(64) not null, email_address varchar(255), primary key (id));
create table visitor_visit_histories (visit_histories_id bigint not null unique, visitor_id bigint not null);
